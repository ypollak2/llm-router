# Historical Changelog — v6.2 and Earlier

This archive contains release notes for v6.2 and earlier versions. For current releases, see [CHANGELOG.md](../CHANGELOG.md).
