...
## [10.1.5] — DeepSeek V4 extract_content fix + routing.yaml policy field support (2026-06-20)
...
## [10.1.4] — Statusline redesign + dashboard accuracy + v9.3 schema-drift prevention layer (2026-06-05)
...
## [10.1.2] — Dashboard persistence + enforce-route deadlock recovery + coordination length-gate (2026-06-05)
...
## [10.1.1] — Expose `llm_session_savings` under the default slim mode (2026-06-03)
...
## [10.1.0] — Tier-grouped routing dashboard + unknown-paid-model cost fallback (2026-06-03)
...
## [10.0.0] — Self-improving router: subject classifier, bandit telemetry, OpenRouter, custom YAML policies (2026-06-03)
...
## [9.4.0] — Savings persistence + statusline accuracy + README discoverability (2026-05-30)
...
## [9.3.2] — Cursor IDE integration (MCP + rules + dashboard tool) (2026-05-27)
...
## [9.3.1] — Gemini CLI full parity + release pipeline fix (2026-05-27)
...
## [9.3.0] — Codex CLI full parity: routing + cost + dashboard (2026-05-27)
...
## [9.2.2] — Cache-aware 4-component savings + task-aware baseline + honest floor (2026-05-27)
...
## [9.2.1] — CONTINUATION heuristic + cooperative DIRECT template (2026-05-27)
...
## [9.2.0] — Enforcement v13, statusline, Gemini CLI savings (2026-05-26)
...
## [9.1.3] — Fix .env loading and echo rendering (2026-05-25)
...
## [9.1.2] — Fix extra env var rejection in RouterConfig (2026-05-25)
...
## [9.1.1] — Claude Code Live-Path Fixes (2026-05-25)
...
## [9.1.0] — Strict Zero-Claude Routing (2026-05-25)
...
## [9.0.10] — Fix: Expanded Routing Continuity (2026-05-25)
...
## [9.0.9] — Fix: Routing Continuity & CLI Errors (2026-05-25)
...
## [9.0.8] — Fix: update Command Package Name (2026-05-24)
...
## [9.0.7] — Polished Direct Execution & System Context (2026-05-24)
...
## [9.0.6] — Fix: Test Stability & Enforcement Logic (2026-05-24)
...
## [9.0.5] — Fix: update Command Error (2026-05-24)
...
## [9.0.4] — Critical Fix: Claude Code Hook Blocking (2026-05-24)
...
## [9.0.3] — Zero-Claude Direct Execution & Mini-Agent Loop (2026-05-24)
...
## [9.0.1] — Dashboard Cleanup & Free-First Routing (2026-05-23)
...
## [9.0.0] — Compaction-Resilient Routing Enforcement (2026-05-23)
...
## [8.7.0] — Cyber-Grid Session Summary (2026-05-15)
...
## [8.6.0] — Mission Control TUI Dashboard (2026-05-15)
...
## [8.5.1] — Hook Path Validation + Python 3.14 Support (2026-05-14)
...
## [8.5.0] — Savings Dashboard + Audit Corrections (2026-05-14)
...
## [8.4.0] — Semantic Cache Enhancements (2026-05-13)
...
## [8.3.0] — Context-Window Cost Optimizer (2026-05-13)
...
## [8.2.0] — Always-On Routing Explainability (2026-05-13)
...
## [8.1.0] — Expanded Provider Support & Dual Downloads Badge (2026-05-09)
...
## [8.0.6] — Fix None quotas crash in dynamic routing (2026-05-09)
...
## [8.0.5] — Pi.dev Host Support & Repo Cleanup (2026-05-06)
...
## [8.0.3] — SVG Animation Fixes & Visual Regression Tests (2026-05-05)
...
## [8.0.2] — CI Fix, README Cleanup, Root Directory Hygiene (2026-05-05)
...
## [8.0.1] — README Motion Refresh & Pepy Tracking Split (2026-05-05)
...
## [8.0.0] — Quality Feedback Loop & Documentation Overhaul (2026-05-05)
...
## [7.6.2] — PyPI README Fix (2026-04-28)
...
## [7.6.1] — Documentation & Test Infrastructure (2026-04-27)
...
## [7.6.0] — Agent Resource Budgeting (2026-04-27)
...
## [7.5.2] — Test Suite Hotfix (2026-04-26)
...
## [7.5.1] — Diagnostics & Violation Reduction (2026-04-26)
...
## [7.5.0] — Flexible Routing Policies & Aggressive Routing (2026-04-24)
...
## [7.4.1] — Repository Cleanup (2026-04-22)
...
## [7.4.0] — Content Generation Routing Discipline (2026-04-22)
...
## [7.3.0] — Session Complexity Insights & Model Distribution Dashboard (2026-04-22)
...
## [7.2.0] — Reliability & Quota Precision (2026-04-21)
...
## [7.1.0] — Quota-Balanced Routing & Cross-Subscription Load Balancing (2026-04-21)
...
## [7.0.1] — CRITICAL: Subscription Protection Fix (2026-04-21)
...
## [7.0.0] — Free-First MCP Chain & Ollama Auto-Startup (2026-04-21)
...
## [6.11.2] — Security & Performance Fixes (2026-04-21)
...
## [6.9.0] — Gemini CLI Integration (2026-04-21)
...
## [6.4.0] — Quality Guard (2026-04-20)
...
## [6.3.0] — Three-Layer Compression Pipeline (2026-04-19)
...
## Roadmap (historical — as planned at v6.4)
