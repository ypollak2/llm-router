...
# The parser lives in the package so `llm-router routing-health` and this
# script share it (one parser; two disagreed on 2026-09-13).
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "src"))
from llm_router.routing_log import (  # noqa: E402
    MIN_SAMPLE, default_log, is_real, load, outcome,
)
