#!/bin/bash
# Publish deprecation package for claude-code-llm_router to PyPI
...
echo "   Package: claude-code-llm_router (redirects to llm-routing)"
echo "   Version: 1.0.0"
echo ""
...
echo ""
echo "Verify on PyPI: https://pypi.org/project/claude-code-llm_router/"
echo ""
