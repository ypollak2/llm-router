...
ENV_REGISTRY: dict[str, tuple[str, str, int]] = {
    ...
    "LLM_ROUTER_AUDIT_DISABLED": ("llm_router", "commands/verify_enterprise.py", 1),
    ...
    "LLM_ROUTER_OIDC_DEFAULT_ORG": ("llm_router", "scim_api.py", 2),
    "LLM_ROUTER_OIDC_DEFAULT_TEAM": ("llm_router", "scim_api.py", 2),
    ...
    "LLM_ROUTER_PROFILE": ("llm_router", "commands/verify_enterprise.py", 3),
    ...
    "LLM_ROUTER_SCIM_ENABLED": ("llm_router", "scim_api.py", 1),
    "LLM_ROUTER_SCIM_ROLE_MAP": ("llm_router", "scim_api.py", 1),
    ...
    "LLM_ROUTER_TOKEN": ("provider_credential", "commands/verify_enterprise.py", 1),
