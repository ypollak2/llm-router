...
def _savings_label(report: dict[str, Any]) -> str:
    ...
    # quiet week does. llm_router.provenance.Measured already encodes this rule --
...
def _slack_payload(report: dict[str, Any]) -> dict:
    ...
    return {
        "blocks": [
            ...
            {
                "type": "context",
                "elements": [{"type": "mrkdwn", "text": "Powered by <https://github.com/ypollak2/llm_router|llm_router>"}],
            },
        ]
    }
...
def _discord_payload(report: dict[str, Any]) -> dict:
    ...
    return {
        "embeds": [{
            ...
            "footer": {"text": "llm_router · github.com/ypollak2/llm_router"},
        }]
    }
...
def _generic_payload(report: dict[str, Any]) -> dict:
    return {"source": "llm_router", "version": "3.0", "report": report}
